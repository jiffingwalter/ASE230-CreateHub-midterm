...
// get if user is an admin if user id is set, auto return false if no user id (not logged in)
$ifAdmin=strlen($userID)>0?isUserAdmin($userID):false;
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                <?= $ifAdmin?'<li class="nav-item"><a class="nav-link" href="../../admin/index.php">Admin Dashboard</a></li>':''?>
